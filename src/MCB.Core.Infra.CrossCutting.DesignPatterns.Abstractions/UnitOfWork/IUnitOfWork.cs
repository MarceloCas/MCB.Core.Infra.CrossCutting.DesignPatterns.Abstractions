...
public interface IUnitOfWork
{
    ...
    Task<(bool success, TOutput? output)> ExecuteAsync<TInput, TOutput>(Func<(TInput? input, bool openTransaction, CancellationToken cancellationToken), Task<(bool, TOutput?)>> handler, TInput? input, bool openTransaction, CancellationToken cancellationToken);
}
